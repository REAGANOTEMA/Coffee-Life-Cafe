(() => {
  ...
  /* ================= CONFIG ================= */
  const WA_NUMBERS = ['256746888730', '256784305795'];
  ...
  const showGoToPayment = () => {
    ...
    if (!pointer) {
      ...
      Object.assign(bubble.style, {
        background: '#ffb300', color: '#000', fontWeight: 'bold',
        padding: '10px 16px', borderRadius: '30px', boxShadow: '0 4px 10px rgba(0,0,0,0.3)',
        animation: 'pulse 1.2s infinite'
      });
      bubble.addEventListener('click', () => { window.location.href = 'payment.html'; });
